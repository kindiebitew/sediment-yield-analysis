...
# Output paths for combined plot
...
# Function to process seasonal sediment yield
def process_seasonal_data(dates, rainfall, discharge, ssc_pred, area_km2, watershed_name):
    ...
    # Calculate sediment load (tonnes/day)
    df['Sediment_Load_tonnes_day'] = df['Discharge'] * df['SSC_predicted'] * 0.0864
    
    # Calculate sediment yield (tonnes/ha/day)
...
# Function to create side-by-side seasonal plot with internal legends
