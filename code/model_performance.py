# Script to evaluate model performance for SSC prediction in Gilgel Abay and Gumara watersheds; Figure 4 in the manuscript.
# Uses uniform hyperparameter tuning for GB, RF, QRF, includes ETo, Sin_Julian, Cos_Julian, drops rainfall lags, uses 70%/30% split.
...
# [Previous script content up to line 355 remains unchanged, including imports, process_watershed, directories, and result unpacking]
